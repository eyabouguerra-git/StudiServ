...
function Home() {
  ...
  const filterServices = () => {
    ...
    if (sortBy === 'rating') {
      ...
      result.sort((a, b) => parseFloat(a.prix || 0) - parseFloat(b.prix || 0));
    } else if (sortBy === 'price_desc') {
      result.sort((a, b) => parseFloat(b.prix || 0) - parseFloat(a.prix || 0));
    }
    ...
    <div className="home">
      ...
      <section className="categories">
        <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
          ...
          <div className="sort-filters" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            <label style={{ fontWeight: 500, color: '#475569' }}>Trier par :</label>
            <select 
              value={sortBy} 
              onChange={(e) => setSortBy(e.target.value)}
              style={{ padding: '0.5rem', borderRadius: '6px', border: '1px solid #cbd5e1', outline: 'none', background: '#fff', color: '#1e293b' }}
            >
